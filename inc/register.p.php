...
do 
{
	...
	{
		echo '<br>
			<input type="radio" name="radio1" value="#1" id="1"checked="check">/me s-a lovit de airbag-ul masini in urma accidentului,avand o rana la nivelul capului.<br>
	...
	{
		echo '<br>
			<input type="radio" name="radio3" value="#1" id="1"checked="check">/me duce mana dreapta la spate urmand sa apuce o arma de tip Remington 870 din pantaloni.<br>
	...
	if($question[$x] == 9)
	{
		echo '<br>
			...
			<input type="radio" name="radio9" value="#2" id="2">Ma uit pem forum daca a postat o poza cu /stat in care ii se vede numarul.<br>
	...
	if($question[$x] == 12)
	{
		echo '<br>
			...
			<input type="radio" name="radio12" value="#2" id="2">Cineva are arma indreptata spre mine iar eu ma pun ii comentez si il injur stind ca o sa primesc PK.<br>
			<input type="radio" name="radio12" value="#3" id="3">Cineva are arma indreptata spre mine iar eu execut toate comenzile spune de acesta in speranta ca nu o sa ma omoara.<br><br>
		';
	}
	$x++;
} while ($x<8);
